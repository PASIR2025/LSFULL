const CACHE_NAME = 'simuplc-hmi-v36-android-usb-flow-20260718';
...
const APP_SHELL = [
  ...
  './arduino512.jpg',
  './assets/css/app.css',
  './assets/js/main.js?v=36',
  './assets/js/hmi-codegen-v17.js',
  './assets/js/webusb-serial-v19.js?v=36',
  './assets/js/hmi-global-control-v22.js?v=36',
  './icons/cursos.png',
  './icons/miscursos.png',
