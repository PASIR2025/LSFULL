const CACHE_NAME = 'simuplc-hmi-v21-global-control-fast-responsive-20260716';
...
const APP_SHELL = [
  ...
  './assets/js/hmi-global-control-v21.js',
  './icons/cursos.png',
  './icons/miscursos.png',
...
self.addEventListener('fetch', (event) => {
  ...
  const isCriticalCode =
    ...
    url.pathname.endsWith('/assets/js/hmi-global-control-v21.js') ||
