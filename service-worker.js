const CACHE_NAME = 'simuplc-hmi-v35-usb-v19-stable-20260718';
...
const APP_SHELL = [
  ...
  './arduino512.jpg',
  './assets/css/app.css',
  './assets/js/main.js?v=35',
  './assets/js/hmi-codegen-v17.js',
  './assets/js/webusb-serial-v19.js?v=35',
  './assets/js/hmi-global-control-v22.js?v=35',
  './icons/cursos.png',
  './icons/miscursos.png',
