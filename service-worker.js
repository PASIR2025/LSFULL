const CACHE_NAME = 'simuplc-hmi-v42-ack-modos-20260719';
...
const APP_SHELL = [
  ...
  './assets/js/hmi-codegen-v17.js?v=42',
  './assets/js/webusb-serial-v20.js?v=42',
  './assets/js/hmi-global-control-v22.js?v=42',
  './icons/cursos.png',
  './icons/miscursos.png',
  ...
  './hardware/PRUEBA_ANDROID_I1_Q1_V42.ino',
