const CACHE_NAME = 'simuplc-hmi-v43-codegen-run-fix-20260719';
...
const APP_SHELL = [
  ...
  './assets/js/webusb-serial-v22.js?v=42',
  './assets/js/hmi-global-control-v23.js?v=43',
  './icons/cursos.png',
  './icons/miscursos.png',
  ...
  './hardware/PRUEBA_ANDROID_I1_Q1_V41_NO_BLOQUEANTE.ino',
  ...
  './CAMBIOS_V42.txt',
  './CAMBIOS_V43.txt',
  './README_SUBIR_A_GITHUB_V41.txt',
  './README_SUBIR_A_GITHUB_V42.txt',
  './README_SUBIR_A_GITHUB_V43.txt'
];
