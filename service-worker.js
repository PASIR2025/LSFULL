const CACHE_NAME = 'simuplc-hmi-v43-native-ack-20260719';
...
const APP_SHELL = [
  ...
  './assets/js/hmi-codegen-v17.js?v=43',
  './assets/js/webusb-serial-v20.js?v=43',
  './assets/js/hmi-global-control-v22.js?v=43',
  './icons/cursos.png',
  './icons/miscursos.png',
  ...
  './hardware/PRUEBA_ANDROID_I1_Q1_V43.ino',
