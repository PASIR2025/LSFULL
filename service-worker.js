const CACHE_NAME = 'simuplc-hmi-v20-control-sources-fast-state-20260716';
...
self.addEventListener('fetch', (event) => {
  ...
  const isCriticalCode =
    url.pathname.endsWith('/service-worker.js') ||
    url.pathname.endsWith('/assets/js/hmi-codegen-v17.js') ||
    url.pathname.endsWith('/assets/js/webusb-serial-v19.js') ||
    url.pathname.endsWith('/assets/js/hmi-runtime-v20.js') ||
