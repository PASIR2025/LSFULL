const CACHE_NAME = 'simuplc-hmi-v40-android-rx-tx-fix-20260719';
...
const APP_SHELL = [
  ...
  './assets/js/webusb-serial-v20.js?v=40',
  './assets/js/hmi-global-control-v22.js?v=40',
  './icons/cursos.png',
  './icons/miscursos.png',
