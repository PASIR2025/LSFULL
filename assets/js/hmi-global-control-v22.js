(function(){
  ...
  function ensureCodegenGlobalUi(){
    ...
    if(status)status.textContent='HMI V22 activo · generador Arduino V21 compatible · modo global · respuesta inmediata.';
    updateModeUi();
  }
  ...
  function installStyles(){
    ...
    const style=document.createElement('style');style.id='simuplc-v21-styles';style.textContent=`
      ...
      @media(max-width:900px) and (orientation:portrait){
        #hmiHost .hmi-editor-toolbar{display:flex!important;flex-wrap:wrap!important;overflow:visible!important;align-content:flex-start!important;padding:5px!important;row-gap:4px!important}
        #hmiHost .hmi-toolbar-field,#hmiApplyTemplateBtn{display:none!important}
        #hmiHost .hmi-view-switch{order:1!important}
        #hmiHost .hmi-mode-switch{order:2!important}
        #hmiStopBtn{order:3!important}
        #hmiToggleUiBtn{order:4!important}
        #hmiGlobalControlV21{order:10!important;flex:1 1 100%!important;width:100%!important;justify-content:center!important;box-sizing:border-box!important}
        #hmiGlobalControlV21 button{flex:1 1 0!important;min-width:0!important;font-size:10px!important;padding:0 5px!important}
        #hmiIoConnectBtn{order:11!important;flex:1 1 auto!important;max-width:none!important}
        #hmiIoSettingsBtn{order:12!important}
        #hmiHost .hmi-io-badge{order:13!important;flex:0 0 auto!important}
        #hmiHost .hmi-connection-badge{display:none!important}
        #hmiHost .hmi-viewport{height:calc(100dvh - 104px)!important}
      }
      ...
      @media(max-width:430px) and (orientation:portrait){
        #hmiHost .hmi-editor-toolbar{gap:3px!important;padding:4px!important}
        #hmiHost .hmi-toolbar-btn,#hmiHost .hmi-nav-btn,#hmiIoConnectBtn,#hmiIoSettingsBtn{height:38px!important;min-height:38px!important;padding-left:7px!important;padding-right:7px!important;font-size:9px!important}
        #hmiGlobalControlV21 button{height:38px!important;min-height:38px!important;font-size:9px!important}
        #hmiHost .hmi-viewport{height:calc(100dvh - 100px)!important}
      }
