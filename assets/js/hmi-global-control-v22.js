(function(){
  ...
  async function sendModeToController(mode){
    ...
    }catch(error){console.warn('[SimuPLC V42] No se pudo sincronizar el modo global:',error);}
  }
  ...
  function ensureCodegenGlobalUi(){
    ...
    if(status)status.textContent='HMI V42 activo · tres modos en tiempo real · ACK de comandos · estado por cambios.';
    updateModeUi();
  }
