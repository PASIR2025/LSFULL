/*
  SimuPLC V40 - Prueba estable Android / OTG
...
const bool OUTPUT_ACTIVE_LOW = true; // Q1=1 apaga el LED D13, igual a tu prueba invertida.
const uint32_t STATE_HEARTBEAT_MS = 1000;
...
void processCommand(String cmd){
  ...
  if(cmd.startsWith("HELLO")){ Serial.println(F("OK,SIMUPLC,READY_V40,1")); updatePhysical(); executeLogic(); sendState(); return; }
...
void setup(){
  pinMode(PIN_I1,INPUT_PULLUP); pinMode(PIN_Q1,OUTPUT); digitalWrite(PIN_Q1,OUTPUT_ACTIVE_LOW?HIGH:LOW);
